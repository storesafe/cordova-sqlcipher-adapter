...
- SQLCipher version information:
  - SQLCipher `4.3.0` for Android - in custom build from <https://github.com/brodybits/android-database-sqlcipher/tree/v4.3.x-defensive-jar-build> (`v4.3.x-defensive-jar-build` branch)
